...
class args:
    ...
    chusai_ad_feature_path = root_data_path + 'chusai_adFeature.csv'
    chusai_user_feature_path = root_data_path + 'chusai_userFeature.data'
    chusai_raw_train_path = root_data_path + 'chusai_train.csv'
    chusai_raw_test1_path = root_data_path + 'chusai_test1.csv'
    chusai_raw_test2_path = root_data_path + 'chusai_test2.csv'
    chusai_combine_train_path = root_data_path + 'chusai_combine_train.csv'
    chusai_combine_test1_path = root_data_path + 'chusai_combine_test1.csv'
    chusai_combine_test2_path = root_data_path + 'chusai_combine_test2.csv'
    random_combine_train_path_with_chusai = root_data_path + 'random_combine_train_with_chusai.csv'

    gbdt_data_path = root_data_path + 'gbdt/'

    dnn_data_path = root_data_path + 'dnn/'
    ...
    static_features = ['interest1_len','interest2_len','interest5_len','aid', 'advertiserId', 'campaignId', 'creativeId', 'creativeSize', 'adCategoryId',
                       'productId', 'productType', 'LBS', 'age', 'carrier',
                       'consumptionAbility', 'education', 'gender', 'house','age_aid','gender_aid','uid_seq']
    uid_count_feature = ['log_uid_uid_times_count','log_uid_uid_pos_times_count_5_fold_all','log_uid_adCategoryId_pos_times_count_5_fold_all',
                 'log_uid_advertiserId_pos_times_count_5_fold_all','log_uid_campaignId_pos_times_count_5_fold_all',
                 'log_uid_creativeId_pos_times_count_5_fold_all','log_uid_creativeSize_pos_times_count_5_fold_all',
                 'log_uid_productId_pos_times_count_5_fold_all','log_uid_productType_pos_times_count_5_fold_all',
    ...
    dynamic_features = ['kw1', 'kw2','kw3', 'topic1', 'topic2', 'topic3','marriageStatus',
                        ...
                        'interest3', 'interest4', 'interest5','interest1_aid','interest2_aid']
