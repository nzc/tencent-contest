...
class args:
    ...
    uid_count_feature = ['uid_uid_times_count_with_chusai_test','log_uid_uid_pos_times_count_5_fold_all','log_uid_adCategoryId_pos_times_count_5_fold_all',
                 ...
                 'uid_adCategoryId_times_count_with_chusai_test','uid_advertiserId_times_count_with_chusai_test',
                 'uid_campaignId_times_count_with_chusai_test','uid_creativeId_times_count_with_chusai_test',
                 'uid_creativeSize_times_count_with_chusai_test','uid_productType_times_count_with_chusai_test',
                 'uid_productId_times_count_with_chusai_test']
    ...
    dynamic_features = ['kw1', 'kw2','kw3', 'topic1', 'topic2', 'topic3','marriageStatus',
                        ...
                        'interest3', 'interest4', 'interest5','interest1_aid','interest2_aid','marriageStatus_aid']
